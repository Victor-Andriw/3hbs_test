        ...
        <q-card>
            <q-card-section>
                <div class="row justify-between">
                    <div class="col-auto text-h5">List of airports</div> 
                    <div class="col-xs-12 col-sm-3 col-md-2">
                        <q-btn color="blue-grey-8 full-width" icon="add" label="Add" @click="open()" > <q-tooltip>Add airports</q-tooltip> </q-btn>
                    </div>
                </div>
            </q-card-section>

            <q-card-section class="q-mt-md">
                <server-table ref="table" :url="'/airports/get-list'" :columns="columns" :loading="true" :pagination="pagination">                   
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                ...
                columns : [   
                    ...
                    { label: 'City', name: 'city', align: 'left', field:'city', filterable: true }, 
        ...
        methods : {
            open(item){ 
                this.title_form = (item !== undefined) ? 'Edit airports' : 'New airports'; 
            ...
            async itemDelete(item){
                ...
                this.$q.loading.show();
                const {data} = await this.$axios.post('/airports/delete', item);
                this.$q.loading.hide();
